...
public static class OperationCommandEmitter
{
    ...
    )
    {
        ...
        var armIdVar = usesResourcePack
            ? char.ToLower(resourcePackConfig!.FieldName[0]) + resourcePackConfig.FieldName[1..] + "Id"
            : null;
        ...
        w.Block(
            ...
            () =>
            {
                ...
                else if (usesResourcePack)
                {
                    ...
                    w.Line($"public readonly {resourcePackConfig!.ClassName} {resourcePackConfig.FieldName} = new();");
                    w.Line();
                }
                else
                {
