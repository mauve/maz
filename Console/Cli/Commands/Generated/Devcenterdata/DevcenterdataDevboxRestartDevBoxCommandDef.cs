...
/// <remarks>Restarts a Dev Box.</remarks>
public partial class DevcenterdataDevboxRestartDevBoxCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "restart-dev-box";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{devCenterEndpointBaseUrl}/projects/{ProjectName}/users/{UserId}/devboxes/{DevBoxName}:restart";
