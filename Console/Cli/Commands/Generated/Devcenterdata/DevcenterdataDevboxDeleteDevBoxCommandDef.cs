...
/// <remarks>Deletes a Dev Box.</remarks>
public partial class DevcenterdataDevboxDeleteDevBoxCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "delete-dev-box";
