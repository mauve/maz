...
/// <remarks>Lists Dev Boxes in the project for a particular user.</remarks>
public partial class DevcenterdataDevboxListDevBoxesByUserCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-dev-boxes-by-user";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{devCenterEndpointBaseUrl}/projects/{ProjectName}/users/{UserId}/devboxes";
