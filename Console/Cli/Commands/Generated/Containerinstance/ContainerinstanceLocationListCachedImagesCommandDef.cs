...
public partial class ContainerinstanceLocationListCachedImagesCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-cached-images";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.ContainerInstance/locations/{Location}/cachedImages";
