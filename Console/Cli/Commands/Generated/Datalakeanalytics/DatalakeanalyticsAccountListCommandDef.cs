...
/// <summary>Gets the first page of Data Lake Analytics accounts, if any, within a specific resource group. This includes a link to the next page, if any.</summary>
/// <remarks>Gets the first page of Data Lake Analytics accounts, if any, within a specific resource group. This includes a link to the next page, if any.</remarks>
public partial class DatalakeanalyticsAccountListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = effectiveRg is not null
            ? $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.DataLakeAnalytics/accounts"
            : $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/providers/Microsoft.DataLakeAnalytics/accounts";
