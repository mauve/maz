...
public partial class DatalakeanalyticsAccountCheckNameCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.DataLakeAnalytics/locations/{Location}/checkNameAvailability";
