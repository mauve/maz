...
/// <remarks>Validate whether adhoc backup will be successful or not</remarks>
public partial class DataprotectionBackupinstanceValidateCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.DataProtection/backupVaults/{VaultName}/validateForBackup";
