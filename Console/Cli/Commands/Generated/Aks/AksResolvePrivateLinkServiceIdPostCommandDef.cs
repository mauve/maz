...
public partial class AksResolvePrivateLinkServiceIdPostCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{resolvedSub}/resourceGroups/{resolvedRg}/providers/Microsoft.ContainerService/managedClusters/{resolvedName}/resolvePrivateLinkServiceId";
