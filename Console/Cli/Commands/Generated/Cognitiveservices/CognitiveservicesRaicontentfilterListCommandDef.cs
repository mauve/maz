...
/// <remarks>List Content Filters types.</remarks>
public partial class CognitiveservicesRaicontentfilterListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.CognitiveServices/locations/{Location}/raiContentFilters";
