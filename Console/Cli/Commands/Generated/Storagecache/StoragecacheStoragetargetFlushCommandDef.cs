...
/// <remarks>Tells the cache to write all dirty data to the Storage Target's backend storage. Client requests to this storage target's namespace will return errors until the flush operation completes.</remarks>
public partial class StoragecacheStoragetargetFlushCommandDef(AuthOptionPack auth) : CommandDef
{
