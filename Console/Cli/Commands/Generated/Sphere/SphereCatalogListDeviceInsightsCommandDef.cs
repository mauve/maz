...
/// <remarks>Lists device insights for catalog.</remarks>
public partial class SphereCatalogListDeviceInsightsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-device-insights";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.AzureSphere/catalogs/{CatalogName}/listDeviceInsights";
