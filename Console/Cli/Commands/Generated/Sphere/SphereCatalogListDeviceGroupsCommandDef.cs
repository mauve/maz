...
/// <remarks>List the device groups for the catalog.</remarks>
public partial class SphereCatalogListDeviceGroupsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-device-groups";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.AzureSphere/catalogs/{CatalogName}/listDeviceGroups";
