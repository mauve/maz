...
/// <remarks>List Image resources by Catalog</remarks>
public partial class SphereImageListByCatalogCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-by-catalog";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.AzureSphere/catalogs/{CatalogName}/images";
