...
/// <remarks>Checks whether the Batch account name is available in the specified region.</remarks>
public partial class BatchLocationCheckNameCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>The result of the request to list operations.</summary>
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.Batch/locations/{LocationName}/checkNameAvailability";
