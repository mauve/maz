...
/// <remarks>Lists the subscriptions for a billing account.</remarks>
public partial class BillingSubscriptionListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    [CliOption("--include-tenant-subscriptions")]
    public partial string? IncludeTenantSubscriptions { get; }

    /// <summary>Can be used to get failed billing subscriptions.</summary>
    [CliOption("--include-failed")]
    public partial string? IncludeFailed { get; }
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/Microsoft.Billing/billingAccounts/{BillingAccountName}/billingSubscriptions";
