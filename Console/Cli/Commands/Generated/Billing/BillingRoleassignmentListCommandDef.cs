...
/// <remarks>Lists the role assignments for the caller on a billing account. The operation is supported for billing accounts with agreement type Microsoft Partner Agreement, Microsoft Customer Agreement or Enterprise Agreement.</remarks>
public partial class BillingRoleassignmentListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/Microsoft.Billing/billingAccounts/{BillingAccountName}/billingRoleAssignments";
