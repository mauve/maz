...
/// <remarks>Lists the enrollment accounts for a billing account. The operation is supported only for billing accounts with agreement type Enterprise Agreement.</remarks>
public partial class BillingEnrollmentaccountListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/Microsoft.Billing/billingAccounts/{BillingAccountName}/enrollmentAccounts";
