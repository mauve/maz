...
/// <remarks>Lists the enrollment accounts for a department. The operation is supported only for billing accounts with agreement type Enterprise Agreement.</remarks>
public partial class BillingEnrollmentaccountListByDepartmentCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/Microsoft.Billing/billingAccounts/{BillingAccountName}/departments/{DepartmentName}/enrollmentAccounts";
