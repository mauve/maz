...
/// <remarks>Lists the subscription aliases for a billing account. The operation is supported for seat based billing subscriptions.</remarks>
public partial class BillingSubscriptionsaliasListByBillingAccountCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/Microsoft.Billing/billingAccounts/{BillingAccountName}/billingSubscriptionAliases";
