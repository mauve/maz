...
/// <remarks>Lists the subscriptions for an enrollment account. The operation is supported for billing accounts with agreement type Enterprise Agreement.</remarks>
public partial class BillingSubscriptionListByEnrollmentAccountCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-by-enrollment-account";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/Microsoft.Billing/billingAccounts/{BillingAccountName}/enrollmentAccounts/{EnrollmentAccountName}/billingSubscriptions";
