...
public partial class ReservationsReservationOrderPurchaseCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var httpResp = await client.SendRawAsync(HttpMethod.Put, path, "2022-11-01", null, ct);
        if (!NoWait)
        {
