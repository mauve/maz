...
public partial class HybridcomputeExtensionMetadataGetCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.HybridCompute/locations/{Location}/publishers/{Publisher}/extensionTypes/{ExtensionType}/versions/{Version}";
