...
/// <remarks>List AutonomousDbVersion resources by SubscriptionLocationResource</remarks>
public partial class OracleAutonomousdatabaseversionListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Oracle.Database/locations/{Location}/autonomousDbVersions";
