...
/// <remarks>List AutonomousDatabaseCharacterSet resources by SubscriptionLocationResource</remarks>
public partial class OracleAutonomousdatabasecharactersetListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Oracle.Database/locations/{Location}/autonomousDatabaseCharacterSets";
