...
/// <remarks>Accept subscription ownership.</remarks>
public partial class SubscriptionSubscriptionAcceptOwnershipCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "accept-ownership";
