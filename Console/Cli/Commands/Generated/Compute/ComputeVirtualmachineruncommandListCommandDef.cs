...
/// <remarks>Lists all available run commands for a subscription in a location.</remarks>
public partial class ComputeVirtualmachineruncommandListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.Compute/locations/{Location}/runCommands";
