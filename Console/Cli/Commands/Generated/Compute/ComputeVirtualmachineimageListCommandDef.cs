...
/// <remarks>Gets a list of all virtual machine image versions for the specified location, publisher, offer, and SKU.</remarks>
public partial class ComputeVirtualmachineimageListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.Compute/locations/{Location}/publishers/{PublisherName}/artifacttypes/vmimage/offers/{Offer}/skus/{Skus}/versions";
