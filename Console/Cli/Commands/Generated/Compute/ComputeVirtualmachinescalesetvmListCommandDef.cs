...
public partial class ComputeVirtualmachinescalesetvmListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.Compute/virtualMachineScaleSets/{VirtualMachineScaleSetName}/virtualMachines";
