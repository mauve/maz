...
/// <remarks>Export logs that show total throttled Api requests for this subscription in the given time window.</remarks>
public partial class ComputeLoganalyticExportThrottledRequestsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "export-throttled-requests";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.Compute/locations/{Location}/logAnalytics/apiAccess/getThrottledRequests";
