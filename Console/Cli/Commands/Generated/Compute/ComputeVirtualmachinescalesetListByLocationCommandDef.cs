...
/// <remarks>Gets all the VM scale sets under the specified subscription for the specified location.</remarks>
public partial class ComputeVirtualmachinescalesetListByLocationCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.Compute/locations/{Location}/virtualMachineScaleSets";
