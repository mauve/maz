...
public partial class NotificationhubsNamespaceCreateCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var httpResp = await client.SendRawAsync(HttpMethod.Put, path, "2023-09-01", body, ct);
        if (!NoWait)
        {
