...
public partial class SfmcManagedClusterVersionShowByEnvironmentCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{subscriptionId}/providers/Microsoft.ServiceFabric/locations/{Location}/environments/{Environment}/managedClusterVersions/{ClusterVersion}";
