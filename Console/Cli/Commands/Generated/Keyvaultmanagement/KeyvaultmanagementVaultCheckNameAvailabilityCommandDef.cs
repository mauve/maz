...
/// <remarks>Checks that the vault name is valid and is not already in use.</remarks>
public partial class KeyvaultmanagementVaultCheckNameAvailabilityCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.KeyVault/checkNameAvailability";
