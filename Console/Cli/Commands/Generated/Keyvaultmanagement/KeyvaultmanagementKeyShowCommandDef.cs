...
/// <remarks>Gets the current version of the specified key from the specified key vault.</remarks>
public partial class KeyvaultmanagementKeyShowCommandDef(AuthOptionPack auth) : CommandDef
{
