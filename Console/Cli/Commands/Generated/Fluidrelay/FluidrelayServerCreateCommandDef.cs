...
public partial class FluidrelayServerCreateCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var result = await client.SendAsync(HttpMethod.Put, path, "2022-06-01", null, ct);
