...
public partial class FluidrelayServerListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/resourceGroups/{ParamResourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers";
