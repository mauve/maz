...
public partial class FluidrelayServerUpdateCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var result = await client.SendAsync(HttpMethod.Patch, path, "2022-06-01", null, ct);
