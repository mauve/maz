...
public partial class WebappWorkflowtriggerListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{resolvedSub}/resourceGroups/{resolvedRg}/providers/Microsoft.Web/sites/{resolvedName}/hostruntime/runtime/webhooks/workflow/api/management/workflows/{WorkflowName}/triggers";
