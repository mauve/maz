...
public partial class WebappSApproveOrRejectPrivateEndpointConnectionCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{resolvedSub}/resourceGroups/{resolvedRg}/providers/Microsoft.Web/sites/{resolvedName}/privateEndpointConnections/{PrivateEndpointConnectionName}";
