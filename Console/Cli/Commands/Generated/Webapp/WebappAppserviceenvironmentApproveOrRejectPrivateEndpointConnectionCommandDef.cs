...
public partial class WebappAppserviceenvironmentApproveOrRejectPrivateEndpointConnectionCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{resolvedSub}/resourceGroups/{resolvedRg}/providers/Microsoft.Web/hostingEnvironments/{resolvedName}/privateEndpointConnections/{PrivateEndpointConnectionName}";
