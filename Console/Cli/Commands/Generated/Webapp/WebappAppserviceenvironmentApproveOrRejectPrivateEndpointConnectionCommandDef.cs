...
public partial class WebappAppserviceenvironmentApproveOrRejectPrivateEndpointConnectionCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "approve-or-reject-private-endpoint-connection";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.Web/hostingEnvironments/{ParamName}/privateEndpointConnections/{PrivateEndpointConnectionName}";
