...
public partial class WebappStaticsiteValidateBackendForBuildCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{resolvedSub}/resourceGroups/{resolvedRg}/providers/Microsoft.Web/staticSites/{resolvedName}/builds/{EnvironmentName}/linkedBackends/{LinkedBackendName}/validate";
