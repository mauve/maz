...
/// <remarks>Lists all synonym maps available for a search service.</remarks>
public partial class SearchdataSynonymmapListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>Selects which top-level properties of the synonym maps to retrieve. Specified as a comma-separated list of JSON property names, or '*' for all properties. The default is all properties.</summary>
    [CliOption("--select")]
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{searchServiceBaseUrl}/synonymmaps";
