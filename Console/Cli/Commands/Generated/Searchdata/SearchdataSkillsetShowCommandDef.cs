...
/// <remarks>Retrieves a skillset in a search service.</remarks>
public partial class SearchdataSkillsetShowCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>The name of the skillset to retrieve.</summary>
