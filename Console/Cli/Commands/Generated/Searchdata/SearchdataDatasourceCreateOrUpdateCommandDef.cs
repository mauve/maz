...
/// <remarks>Creates a new datasource or updates a datasource if it already exists.</remarks>
public partial class SearchdataDatasourceCreateOrUpdateCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>The name of the datasource to create or update.</summary>
