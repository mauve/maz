...
/// <remarks>Retrieves an indexer definition.</remarks>
public partial class SearchdataIndexerShowCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>The name of the indexer to retrieve.</summary>
