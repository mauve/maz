...
/// <remarks>Lists all datasources available for a search service.</remarks>
public partial class SearchdataDatasourceListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>Selects which top-level properties of the data sources to retrieve. Specified as a comma-separated list of JSON property names, or '*' for all properties. The default is all properties.</summary>
    [CliOption("--select")]
