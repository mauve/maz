...
/// <remarks>Upgrade a profile from Standard_AzureFrontDoor to Premium_AzureFrontDoor.</remarks>
public partial class CdnAfdprofileUpgradeCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    [CliOption("--waf-mapping-list", Required = true)]
    public partial string? WafMappingList { get; }
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.Cdn/profiles/{ProfileName}/upgrade";

        var body = BodyJson is { } rawJson
            ? JsonNode.Parse(rawJson)!.AsObject()
            : new JsonObject
            {
                ["wafMappingList"] = JsonValue.Create(WafMappingList),
            };
