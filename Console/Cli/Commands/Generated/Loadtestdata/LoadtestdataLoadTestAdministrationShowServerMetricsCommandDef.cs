...
public partial class LoadtestdataLoadTestAdministrationShowServerMetricsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "show-server-metrics";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{loadTestEndpointBaseUrl}/tests/{TestId}/server-metrics-config";
