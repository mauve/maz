...
/// <remarks>Create glossary terms in bulk.</remarks>
public partial class PurviewdataGlossaryCreateTermsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "create-terms";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/glossary/terms";
