...
/// <remarks>Associate a classification to multiple entities in bulk.</remarks>
public partial class PurviewdataEntityAddClassificationCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "add-classification";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/entity/bulk/classification";
