...
/// <remarks>Update the given glossary category by its GUID.</remarks>
public partial class PurviewdataGlossaryUpdateCategoryCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/glossary/category/{CategoryId}";
