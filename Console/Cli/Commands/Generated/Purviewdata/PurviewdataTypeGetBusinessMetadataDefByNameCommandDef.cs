...
/// <remarks>Get the businessMetadata definition by it's name (unique).</remarks>
public partial class PurviewdataTypeGetBusinessMetadataDefByNameCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-business-metadata-def-by-name";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/types/businessmetadatadef/name/{ParamName}";
