...
/// <remarks>Get the term template definition for the given GUID.</remarks>
public partial class PurviewdataTypeGetTermTemplateDefByGuidCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-term-template-def-by-guid";
    ...
    /// <summary>The globally unique identifier of the term template.</summary>
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/types/termtemplatedef/guid/{Guid}";
