...
/// <remarks>Get the type definition for the given GUID.</remarks>
public partial class PurviewdataTypeGetByGuidCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-by-guid";
    ...
    /// <summary>The globally unique identifier of the type.</summary>
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/types/typedef/guid/{Guid}";
