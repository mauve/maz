...
/// <remarks>Delete given labels to a given entity.</remarks>
public partial class PurviewdataEntityRemoveLabelsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "remove-labels";
