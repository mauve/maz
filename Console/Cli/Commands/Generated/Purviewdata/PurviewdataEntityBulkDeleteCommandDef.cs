...
/// <remarks>Delete a list of entities in bulk identified by their GUIDs or unique attributes.</remarks>
public partial class PurviewdataEntityBulkDeleteCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "bulk-delete";
    ...
    /// <summary>An array of GUIDs of entities to delete.</summary>
