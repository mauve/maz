...
/// <remarks>Create a glossary category.</remarks>
public partial class PurviewdataGlossaryCreateCategoryCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/glossary/category";
