...
/// <remarks>Get search suggestions by query criteria.</remarks>
public partial class PurviewdataDiscoverySuggestCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/search/suggest";
