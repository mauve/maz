...
/// <remarks>Remove business metadata from an entity.</remarks>
public partial class PurviewdataEntityRemoveBusinessMetadataCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "remove-business-metadata";
