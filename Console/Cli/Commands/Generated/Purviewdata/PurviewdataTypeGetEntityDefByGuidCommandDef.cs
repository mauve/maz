...
/// <remarks>Get the Entity definition for the given GUID.</remarks>
public partial class PurviewdataTypeGetEntityDefByGuidCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-entity-def-by-guid";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/types/entitydef/guid/{Guid}";
