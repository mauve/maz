...
/// <remarks>Create a glossary term.</remarks>
public partial class PurviewdataGlossaryCreateTermCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "create-term";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{dataplaneRef}/atlas/v2/glossary/term";
