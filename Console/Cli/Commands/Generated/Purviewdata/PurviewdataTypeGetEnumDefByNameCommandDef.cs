...
/// <remarks>Get the enum definition by its name (unique).</remarks>
public partial class PurviewdataTypeGetEnumDefByNameCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-enum-def-by-name";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/types/enumdef/name/{ParamName}";
