...
/// <remarks>Get the sample Template for uploading/creating bulk BusinessMetaData</remarks>
public partial class PurviewdataEntityGetSampleBusinessMetadataTemplateCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-sample-business-metadata-template";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/entity/businessmetadata/import/template";
