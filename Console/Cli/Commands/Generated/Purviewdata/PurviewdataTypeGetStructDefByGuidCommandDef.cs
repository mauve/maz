...
/// <remarks>Get the struct definition for the given GUID.</remarks>
public partial class PurviewdataTypeGetStructDefByGuidCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-struct-def-by-guid";
    ...
    /// <summary>The globally unique identifier of the struct.</summary>
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/types/structdef/guid/{Guid}";
