...
/// <remarks>Set classifications on entities in bulk.</remarks>
public partial class PurviewdataEntityBulkSetClassificationsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "bulk-set-classifications";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/entity/bulk/setClassifications";
