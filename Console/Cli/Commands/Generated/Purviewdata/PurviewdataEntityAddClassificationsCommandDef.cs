...
/// <remarks>Add classifications to an existing entity represented by a GUID.</remarks>
public partial class PurviewdataEntityAddClassificationsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "add-classifications";
