...
/// <remarks>Create glossary category in bulk.</remarks>
public partial class PurviewdataGlossaryCreateCategoriesCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "create-categories";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/glossary/categories";
