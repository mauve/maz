...
/// <remarks>Get entity header given its GUID.</remarks>
public partial class PurviewdataEntityGetHeaderCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/entity/guid/{Guid}/header";
