...
/// <remarks>Get the term template definition by its name (unique).</remarks>
public partial class PurviewdataTypeGetTermTemplateDefByNameCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-term-template-def-by-name";
    ...
    /// <summary>The unique name of the term template.</summary>
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/types/termtemplatedef/name/{ParamName}";
