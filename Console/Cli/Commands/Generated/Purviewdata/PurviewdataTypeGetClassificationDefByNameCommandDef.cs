...
/// <remarks>Get the classification definition by its name (unique).</remarks>
public partial class PurviewdataTypeGetClassificationDefByNameCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-classification-def-by-name";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{purviewEndpointBaseUrl}/atlas/v2/types/classificationdef/name/{ParamName}";
