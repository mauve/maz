...
/// <remarks>Set labels to a given entity.</remarks>
public partial class PurviewdataEntitySetLabelsCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "set-labels";
