...
/// <remarks>Delete the term assignment for the given list of related objects.</remarks>
public partial class PurviewdataGlossaryDeleteTermAssignmentFromEntitiesCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "delete-term-assignment-from-entities";
