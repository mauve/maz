...
/// <remarks>Get the details about the subscription of a topic.</remarks>
public partial class ServicebusdataSubscriptionShowCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{serviceBusBaseUrl}/{TopicName}/subscriptions/{SubscriptionName}";
