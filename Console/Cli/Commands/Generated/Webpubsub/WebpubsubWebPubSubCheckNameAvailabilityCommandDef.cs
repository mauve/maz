...
public partial class WebpubsubWebPubSubCheckNameAvailabilityCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.SignalRService/locations/{Location}/checkNameAvailability";
