...
public partial class ConsumptionBudgetCreateCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var result = await client.SendAsync(HttpMethod.Put, path, "2024-08-01", null, ct);
