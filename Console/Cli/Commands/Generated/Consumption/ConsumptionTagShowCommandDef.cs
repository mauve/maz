...
/// <remarks>Get all available tag keys for the defined scope</remarks>
public partial class ConsumptionTagShowCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/{Scope}/providers/Microsoft.Consumption/tags";
