...
/// <remarks>Get the shared scheduled action from the given scope by name.</remarks>
public partial class CostmanagementScheduledactionShowCommandDef(AuthOptionPack auth) : CommandDef
{
