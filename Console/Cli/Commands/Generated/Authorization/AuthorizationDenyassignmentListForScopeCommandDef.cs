...
/// <remarks>Gets deny assignments for a scope.</remarks>
public partial class AuthorizationDenyassignmentListForScopeCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-for-scope";

    public readonly RenderOptionPack Render = new();

    /// <summary>The scope of the deny assignments.</summary>
