...
/// <remarks>Promotes read replica cluster to an independent read-write cluster.</remarks>
public partial class PostgresqlhscClusterPromoteReadReplicaCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "promote-read-replica";
