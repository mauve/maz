...
/// <remarks>Queries policy states for the subscription level policy definition.</remarks>
public partial class PolicyinsightsPolicystateListQueryResultsForPolicyDefinitionCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/{AuthorizationNamespace}/policyDefinitions/{PolicyDefinitionName}/providers/Microsoft.PolicyInsights/policyStates/{PolicyStatesResource}/queryResults";
