...
/// <remarks>Queries policy events for the subscription level policy set definition.</remarks>
public partial class PolicyinsightsPolicyeventListQueryResultsForPolicySetDefinitionCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-query-results-for-policy-set-definition";
    ...
    [CliOption("--policy-set-definition-name", Required = true)]
    public partial string? PolicySetDefinitionName { get; }
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/{AuthorizationNamespace}/policySetDefinitions/{PolicySetDefinitionName}/providers/Microsoft.PolicyInsights/policyEvents/{PolicyEventsResource}/queryResults";
