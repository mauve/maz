...
/// <remarks>Queries policy events for the subscription level policy assignment.</remarks>
public partial class PolicyinsightsPolicyeventListQueryResultsForSubscriptionLevelPolicyAssignmentCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/{AuthorizationNamespace}/policyAssignments/{PolicyAssignmentName}/providers/Microsoft.PolicyInsights/policyEvents/{PolicyEventsResource}/queryResults";
