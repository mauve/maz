...
/// <remarks>Queries policy events for the resources under the management group.</remarks>
public partial class PolicyinsightsPolicyeventListQueryResultsForManagementGroupCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-query-results-for-management-group";
    ...
    [CliOption("--management-group-name", Required = true)]
    public partial string? ManagementGroupName { get; }
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/{ManagementGroupsNamespace}/managementGroups/{ManagementGroupName}/providers/Microsoft.PolicyInsights/policyEvents/{PolicyEventsResource}/queryResults";
