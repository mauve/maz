...
/// <remarks>Gets all remediations for a resource.</remarks>
public partial class PolicyinsightsRemediationListForResourceCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/{ResourceId}/providers/Microsoft.PolicyInsights/remediations";
