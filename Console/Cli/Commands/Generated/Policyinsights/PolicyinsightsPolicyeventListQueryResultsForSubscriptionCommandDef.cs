...
/// <remarks>Queries policy events for the resources under the subscription.</remarks>
public partial class PolicyinsightsPolicyeventListQueryResultsForSubscriptionCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.PolicyInsights/policyEvents/{PolicyEventsResource}/queryResults";
