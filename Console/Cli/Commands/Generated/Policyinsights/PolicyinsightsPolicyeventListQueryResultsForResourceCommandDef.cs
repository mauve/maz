...
/// <remarks>Queries policy events for the resource.</remarks>
public partial class PolicyinsightsPolicyeventListQueryResultsForResourceCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/{ResourceId}/providers/Microsoft.PolicyInsights/policyEvents/{PolicyEventsResource}/queryResults";
