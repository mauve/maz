...
public partial class PolicyinsightsRemediationListForSubscriptionCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.PolicyInsights/remediations";
