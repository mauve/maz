...
/// <remarks>Queries policy events for the resource group level policy assignment.</remarks>
public partial class PolicyinsightsPolicyeventListQueryResultsForResourceGroupLevelPolicyAssignmentCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourcegroups/{ResourceGroup.RequireResourceGroupName()}/providers/{AuthorizationNamespace}/policyAssignments/{PolicyAssignmentName}/providers/Microsoft.PolicyInsights/policyEvents/{PolicyEventsResource}/queryResults";
