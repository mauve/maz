...
/// <remarks>Gets all attestations for the subscription.</remarks>
public partial class PolicyinsightsAttestationListForSubscriptionCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.PolicyInsights/attestations";
