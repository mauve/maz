...
/// <remarks>Queries policy states for the resources under the subscription.</remarks>
public partial class PolicyinsightsPolicystateListQueryResultsForSubscriptionCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "list-query-results-for-subscription";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.PolicyInsights/policyStates/{PolicyStatesResource}/queryResults";
