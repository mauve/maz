...
/// <remarks>Summarizes policy states for the subscription level policy assignment.</remarks>
public partial class PolicyinsightsPolicystateSummarizeForSubscriptionLevelPolicyAssignmentCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "summarize-for-subscription-level-policy-assignment";
