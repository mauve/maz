...
/// <remarks>Get a list of Target Type resources for given location.</remarks>
public partial class ChaosTargettypeListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{Subscription.RequireSubscriptionId()}/providers/Microsoft.Chaos/locations/{Location}/targetTypes";
