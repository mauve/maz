...
/// <remarks>Get manifest attributes</remarks>
public partial class AcrdataContainerRegistryShowManifestPropertiesCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "show-manifest-properties";
