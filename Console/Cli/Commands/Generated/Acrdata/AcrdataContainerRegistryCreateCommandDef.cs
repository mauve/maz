...
/// <remarks>Put the manifest identified by `name` and `reference` where `reference` can be a tag or digest.</remarks>
public partial class AcrdataContainerRegistryCreateCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>A tag or a digest, pointing to a specific image</summary>
