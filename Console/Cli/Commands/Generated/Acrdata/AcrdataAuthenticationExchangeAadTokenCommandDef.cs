...
/// <remarks>Exchange AAD tokens for an ACR refresh Token</remarks>
public partial class AcrdataAuthenticationExchangeAadTokenCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "exchange-aad-token";
