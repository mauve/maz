...
/// <remarks>Update properties of a manifest</remarks>
public partial class AcrdataContainerRegistryUpdateManifestPropertiesCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "update-manifest-properties";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{dataplaneRef}/acr/v1/{ParamName}/_manifests/{Digest}";
