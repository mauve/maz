...
/// <remarks>Create or update an Azure Cosmos DB SQL trigger</remarks>
public partial class CosmosdbSqlresourceCreateUpdateSqlTriggerCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "create-update-sql-trigger";
