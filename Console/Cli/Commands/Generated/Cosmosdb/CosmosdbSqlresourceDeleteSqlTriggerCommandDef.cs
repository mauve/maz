...
/// <remarks>Deletes an existing Azure Cosmos DB SQL trigger.</remarks>
public partial class CosmosdbSqlresourceDeleteSqlTriggerCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "delete-sql-trigger";
