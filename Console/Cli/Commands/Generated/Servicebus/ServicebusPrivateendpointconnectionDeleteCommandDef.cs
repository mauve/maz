...
public partial class ServicebusPrivateendpointconnectionDeleteCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/subscriptions/{resolvedSub}/resourceGroups/{resolvedRg}/providers/Microsoft.ServiceBus/namespaces/{resolvedName}/privateEndpointConnections/{PrivateEndpointConnectionName}";
