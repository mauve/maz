...
public partial class BatchdataJobListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    /// <summary>An OData $filter clause. For more information on constructing this filter, see https://learn.microsoft.com/rest/api/batchservice/odata-filters-in-batch#list-jobs.</summary>
    [CliOption("--filter")]
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{batchAccountBaseUrl}/jobs";
