...
public partial class BatchdataNodeGetNodeCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "get-node";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{batchAccountBaseUrl}/pools/{PoolId}/nodes/{NodeId}";
