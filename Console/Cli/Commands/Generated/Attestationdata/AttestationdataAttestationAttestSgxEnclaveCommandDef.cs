...
public partial class AttestationdataAttestationAttestSgxEnclaveCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "attest-sgx-enclave";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{attestationProviderBaseUrl}/attest/SgxEnclave";
