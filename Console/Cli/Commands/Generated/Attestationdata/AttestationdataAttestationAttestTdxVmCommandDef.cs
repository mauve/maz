...
/// <remarks>Processes an TDX quote, producing an artifact. The type of artifact produced is dependent upon attestation policy.</remarks>
public partial class AttestationdataAttestationAttestTdxVmCommandDef(AuthOptionPack auth) : CommandDef
{
    public override string Name => "attest-tdx-vm";
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"{attestationProviderBaseUrl}/attest/TdxVm";
