...
public partial class SignalrSignalRListCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = effectiveRg is not null
            ? $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/resourceGroups/{ResourceGroup.RequireResourceGroupName()}/providers/Microsoft.SignalRService/signalR"
            : $"/subscriptions/{ResourceGroup.Subscription.RequireSubscriptionId()}/providers/Microsoft.SignalRService/signalR";
