...
/// <remarks>Check the availability of a Front Door resource name.</remarks>
public partial class FrontdoorNameAvailabilityCheckCommandDef(AuthOptionPack auth) : CommandDef
{
    ...
    protected override async Task<int> ExecuteAsync(CancellationToken ct)
    {
        ...
        var path = $"/providers/Microsoft.Network/checkFrontDoorNameAvailability";
